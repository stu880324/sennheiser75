        ...
        <div class="product-card wow slideInUp">
          <div class="icons-part">
            <a href="" class="icons">
              <img
                class="iconsvg"
                src="images/2_productList/icons/shopcar.svg"
                alt=""
              />
            </a>
            ...
            <a href="" class="icons">
              <img
                class="iconsvg"
                src="images/2_productList/icons/heart.svg"
                alt=""
              />
            </a>
          </div>
    ...
    <div class="container carousel" id="carousel" data-state="0">
      ...
      <div class="carousel-big-images">
        <div class="carousel-big-image" data-key="0">
          <img
            src="images/2_productList/poductlist-carousel/carousel01.jpg"
            alt=""
          />
        </div>
        <div class="carousel-big-image" data-key="1">
          <img
            src="images/2_productList/poductlist-carousel/carousel02.jpg"
            alt=""
          />
        </div>
        <div class="carousel-big-image" data-key="2">
          <img
            src="images/2_productList/poductlist-carousel/carousel03.jpg"
            alt=""
          />
        </div>
        <div class="carousel-big-image" data-key="3">
          <img
            src="images/2_productList/poductlist-carousel/carousel04.jpg"
            alt=""
          />
        </div>
        <div class="carousel-big-image" data-key="4">
          <img
            src="images/2_productList/poductlist-carousel/carousel05.jpg"
            alt=""
          />
        </div>
      </div>
