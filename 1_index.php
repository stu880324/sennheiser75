...
<div class="container-fluid hero">
      ...
      <div class="row hero-area">
        ...
        <div class="arrow">
          <a href="#box-title"
            ><img src="images/1_index/icon desing/arrow.svg" alt=""
          /></a>
        </div>
      </div>
    </div>
      ...
      <div class="row threefeatures">
        <div class="col-sm-12 col-lg-4">
          <div class="feature-image">
            <img
              src="images/1_index/icon desing/icon/德國工藝icon-黑.svg"
              alt=""
            />
          </div>
    ...
    <div class="container-fluid topsale-area">
      ...
      <div class="top3-area">
        <div class="top3-wrap">
          <div class="topsale">
            <div
              class="col-lg-4 topsale-left wow slideInLeft"
            ...
            <div class="col-lg-4 topsale-right wow slideInDown">
              <img
                class="pr-5"
                src="images/1_index/hot sale/right.png"
                alt=""
              />
            </div>
          </div>
          ...
          <div class="topsale">
            <div
              class="col-lg-4 topsale-left"
              data-wow-duration="1s"
              data-wow-delay="1s"
            >
              <img
                class="pl-5"
                src="images/1_index/hot sale/left02.png"
                alt=""
              />
            </div>
            ...
            <div class="col-lg-4 topsale-right">
              <img
                class="pr-5"
                src="images/1_index/hot sale/right02.png"
                alt=""
              />
            </div>
          </div>
          ...
          <div class="topsale">
            ...
            >
              <img
                class="pl-5"
                src="images/1_index/hot sale/left03.png"
                alt=""
              />
            </div>
            ...
            <div class="col-lg-4 topsale-right">
              <img
                class="pr-5"
                src="images/1_index/hot sale/right03.png"
                alt=""
              />
            </div>
          </div>
    ...
    <div class="container-fluid sennheiser-anniversary">
      <div class="row anniversary-text">
        <div class="text75">
          ...
          <span
            >2020年是 Sennheiser 創立75周年的重要里程碑！<br />
