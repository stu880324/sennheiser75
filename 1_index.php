  ...
  <div class="row threefeatures">
    <div class="col-sm-12 col-lg-4">
      <div class="feature-image">
        <img src="./sennheiser75/images/1_index/icon desing/icon/crafticon-black.svg" alt="" />
      </div>
    ...
    <div class="col-sm-12 col-lg-4">
      <div class="feature-image">
        <img src="./sennheiser75/images/1_index/icon desing/icon/warranty-black.svg" alt="" />
      </div>
    ...
    <div class="col-sm-12 col-lg-4">
      <div class="feature-image">
        <img src="./sennheiser75/images/1_index/icon desing/icon/sound-black.svg" alt="" />
      </div>
